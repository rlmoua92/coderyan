...
const cards = [
  {value: "CARD", color: "red"},{value: "CARD", color: "neutral"},{value: "CARD", color: "black"},{value: "CARD", color: "blue"},{value: "CARD", color: "neutral"},
  ...
  {value: "CARD", color: "neutral"},{value: "CARD", color: "blue"},{value: "CARD", color: "blue"},{value: "CARD", color: "neutral"},{value: "CARD", color: "red"},
];
...
class BoardContainer extends Component {
  render() {
    ...
    return (
      <Board height={height} width={width} cards={cards} onCardClick={this.props.onCardClick} />
    );
  }
}
